...
class Levels(CogMeta):
    ...
    @example(",level message You leveled up to {level}!")
    @level.command()
    @commands.has_permissions(manage_guild=True)
