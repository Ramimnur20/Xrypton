...
class Moderation(CogMeta):
    ...
    @example(",ban @voby for being annoying")
    @command(
        name="ban",
    ...
    @example(",forcenickname @voby newname")
    @command(
        name="forcenickname",
        aliases=["fn"],
    ...
    @example(",lockdown #channel Locked channel")
    @hybrid_group(
        name="lockdown",
        aliases=["lock"],
    ...
    @example(",unlock #channel Unlocked channel")
